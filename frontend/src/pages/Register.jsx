...
const Register = () => {
  ...
  return (
    <section className="mx-auto max-w-xl rounded-4xl border border-slate-800 bg-slate-900/80 p-8 shadow-xl shadow-slate-950/40">
      ...
      <p className="mt-3 text-slate-400">Join VisionBoard to upload, save, and share visual inspiration.</p>
      ...
      <p className="mt-6 text-center text-sm text-slate-500">
        Already on VisionBoard?{' '}
        <Link to="/login" className="font-semibold text-slate-100 hover:text-cyan-300">
          Log in
        </Link>
      </p>
    </section>
